                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-v1-auth-logout">POST api/v1/auth/logout</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-v1-auth-otp-send">
                                <a href="#authentication-POSTapi-v1-auth-otp-send">POST api/v1/auth/otp/send</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-v1-auth-otp-verify">
                                <a href="#authentication-POSTapi-v1-auth-otp-verify">POST api/v1/auth/otp/verify</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-v1-auth-password-reset">
                                <a href="#authentication-POSTapi-v1-auth-password-reset">POST api/v1/auth/password/reset</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Email or phone number. Example: <code>user@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-POSTapi-v1-auth-otp-send">POST api/v1/auth/otp/send</h2>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;data&quot;: {
        &quot;identifier&quot;: &quot;user@example.com&quot;,
        &quot;type&quot;: &quot;email&quot;,
        &quot;expires_at&quot;: &quot;2025-12-05T21:20:00+00:00&quot;
    }
}</code>
 </pre>
            <blockquote>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="identifier"                data-endpoint="POSTapi-v1-auth-otp-send"
               value="user@example.com"
               data-component="body">
    <br>
<p>Email or phone number. Example: <code>user@example.com</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="POSTapi-v1-auth-otp-send"
               value="email"
               data-component="body">
    <br>
<p>OTP type (email or phone). Example: <code>email</code></p>
        </div>
        </form>

                    <h2 id="authentication-POSTapi-v1-auth-otp-verify">POST api/v1/auth/otp/verify</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="POSTapi-v1-auth-otp-verify"
               value="email"
               data-component="body">
    <br>
<p>OTP type (email or phone). Example: <code>email</code></p>
                    ...
                    <h2 id="authentication-POSTapi-v1-auth-password-reset">POST api/v1/auth/password/reset</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="code"                data-endpoint="POSTapi-v1-auth-password-reset"
               value="123456"
               data-component="body">
    <br>
<p>6-digit OTP code. Example: <code>123456</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="POSTapi-v1-auth-password-reset"
               value="email"
               data-component="body">
    <br>
<p>OTP type (email or phone). Example: <code>email</code></p>
