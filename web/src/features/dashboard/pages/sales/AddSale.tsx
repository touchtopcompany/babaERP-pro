...
const AddSale: React.FC = () => {
  ...
  }, [products, discountType, discountAmount, orderTax, shippingCharges, additionalExpenses, paymentAmount]);
  ...
  const handleProductChange = (key: string, field: keyof SaleProductRow, value: any) => {
    setProducts(
      products.map((p) => {
        if (p.key === key) {
  ...
  const productColumns: ColumnsType<SaleProductRow> = [
    {
      title: "Product",
  ...
  return (
    <div>
      ...
      >
        ...
        {/* Customer Details and Sale Details Section */}
        <Row gutter={[16, 16]} style={{ marginBottom: "24px" }}>
        ...
        >
          ...
          <Row gutter={[16, 16]}>
            ...
            <Col xs={24} sm={12}>
              <Text style={{ color: isDark ? "rgba(255,255,255,0.85)" : "#595959" }}>
                Change Return: TSh {totals.changeReturn.toFixed(2)}
              </Text>
            </Col>
            <Col xs={24} sm={12}>
              <Text style={{ color: isDark ? "rgba(255,255,255,0.85)" : "#595959" }}>
                Balance: TSh {totals.balance.toFixed(2)}
              </Text>
            </Col>
          </Row>
        </Card>
