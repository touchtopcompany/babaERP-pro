...
const Brands: React.FC = () => {
  ...
  const defaultBrands: BrandData[] = [
    {
      key: "1",
      brand: "Nike",
      note: "Athletic footwear and apparel brand",
    },
    {
      key: "2",
      brand: "Samsung",
      note: "Electronics and technology products",
    },
    {
      key: "3",
      brand: "Apple",
      note: "Consumer electronics and software",
    },
    {
      key: "4",
      brand: "Sony",
      note: "Electronics, gaming, and entertainment",
    },
    {
      key: "5",
      brand: "Adidas",
      note: "Sportswear and athletic equipment",
    },
  ];
  ...
  const filteredBrands = useMemo(() => {
    ...
    return brands.filter(
      (brand) =>
        ...
        brand.note.toLowerCase().includes(searchLower)
    );
  }, [brands, searchText]);
  ...
  const handleRefresh = () => {
    setLoading(true);
    // TODO: Implement API call to refresh brands
    setTimeout(() => {
      setLoading(false);
  ...
  const handleExportCSV = () => {
    ...
    message.success("Brands exported to CSV successfully");
  };
  ...
  const handlePrint = () => {
    ...
    const tableHTML = `
      <html>
        ...
        <body>
          <h1>Brands Management Report</h1>
  ...
  return (
    <div>
      ...
      >
        ...
        <style>{`
          .brands-table .ant-table-thead > tr > th {
            transition: all 0.2s ease;
            cursor: pointer;
          }
          .brands-table .ant-table-thead > tr > th:hover {
            background: ${isDark ? "rgba(24, 144, 255, 0.3)" : "rgba(24, 144, 255, 0.9)"} !important;
          }
          .brands-table .ant-table-tbody > tr {
            transition: all 0.2s ease;
          }
          .brands-table .ant-table-tbody > tr:hover > td {
            background: ${isDark ? "rgba(24, 144, 255, 0.1)" : "rgba(24, 144, 255, 0.05)"} !important;
          }
          .brands-table .ant-table-tbody > tr:hover {
            transform: translateY(-1px);
            box-shadow: ${isDark ? "0 2px 8px rgba(0,0,0,0.2)" : "0 2px 8px rgba(0,0,0,0.08)"};
          }
          .brands-table .ant-table-column-sorter {
            color: ${isDark ? "rgba(255,255,255,0.65)" : "rgba(0,0,0,0.45)"} !important;
          }
          .brands-table .ant-table-column-sorted .ant-table-column-sorter-up,
          .brands-table .ant-table-column-sorted .ant-table-column-sorter-down,
          .brands-table .ant-table-column-sorter-up.on,
          .brands-table .ant-table-column-sorter-down.on,
          .brands-table .ant-table-column-sorter-up.active,
          .brands-table .ant-table-column-sorter-down.active {
      ...
      <AddModal
        ...
        fields={[
          ...
          { name: "note", label: "Note", type: "textarea", required: false, placeholder: "Enter note or description" },
        ]}
      ...
      <DeleteModal
        ...
        onConfirm={async () => {
          ...
          try {
            ...
            setBrands(brands.filter((b) => b.key !== selectedBrand?.key));
            setDeleteModalOpen(false);
            setSelectedBrand(null);
          } catch (_error) {
