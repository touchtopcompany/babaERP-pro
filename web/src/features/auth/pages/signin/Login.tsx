        ...
        <div className="w-full md:w-1/2 p-16">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <Link
                to="/"
                className="block w-full text-center py-3 px-4 bg-black text-white text-sm font-medium rounded-full hover:bg-black/90 focus:outline-none  transition-colors duration-200"
              >
                Continue
              </Link>
            </div>
